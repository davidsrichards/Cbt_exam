          ...
          <div className="grid grid-cols-1 transition justify-items-center container mx-auto  lg:w-1/2 lg:p-0 p-4 m-4 w-full">
            ...
            <div className="w-full space-y-3">
              ...
              <input
                ...
                className="p-4 text-slate-500 bg-slate-200 font-serif rounded-sm ring-2 ring-white w-full transition  delay-100  hover:ring-blue-400 outline-none in"
              />
            </div>
            {/*  */}
            <button
            ...
            <div className="flex items-center justify-center text-white w-full mt-6">
              ...
              <span className=" text-nowrap px-2 text-center">
                Or continue with
              </span>
              <hr className="w-full border-slate-600" />
            </div>
