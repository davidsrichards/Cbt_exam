...
function AdminRegistration() {
  ...
  return (
    <div className="bg-[url(https://images.pexels.com/photos/3769021/pexels-photo-3769021.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2)] bg-center bg-cover bg-fixed rounded-lg flex items-center justify-center w-full h-screen overflow-auto">
      <form
        action=""
        method="POST"
        onSubmit={(e) => {
        ...
        className="w-full"
      >
        <div className="w-full grid grid-cols-1 container mx-auto sm:p-12 p-2 gap-6 justify-items-center mt-[10rem]">
