...
function GlobalAdminQuestion({ oldPath, newPath }) {
  // dispatch
  ...
  const handleFinish = (e) => {
    ...
    const newPaths = currentPath.replace(oldPath, newPath);
    return navigate(newPaths, { replace: true, relative: true });
  };
...
export default GlobalAdminQuestion;
